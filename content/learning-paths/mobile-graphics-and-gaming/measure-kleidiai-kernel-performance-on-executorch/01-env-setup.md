...
Before building ExecuTorch, it is recommended to create an isolated Python environment to avoid dependency conflicts with your system Python.
...
All subsequent operations are expected to be performed within this Python environment.
...
The following steps are based on ExecuTorch v1.0.0; steps or configurations may differ in later versions.
